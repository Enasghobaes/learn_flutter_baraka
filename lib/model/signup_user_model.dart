...
class SignupUserModel extends ResultModel {
  String firstName;
  String lastName;
  String email;
  String role;
  ...
  factory SignupUserModel.fromJson(String source) =>
      SignupUserModel.fromMap(json.decode(source) as Map<String, dynamic>);
